...
<div class="register-form mt-5 px-3">
    <form  method="post">
        <div class="form-group text-left mb-4">
            ...
            <input class="form-control" id="username" type="text" name="full_name" placeholder="Full Name">
        </div>
        <div class="form-group text-left mb-4">
            <label for="email"><i class="lni lni-envelope"></i></label>
            <input class="form-control" id="email" type="email" name="acct_email" placeholder="Email Address">
        </div>
        <div class="form-group text-left mb-4">
...
<div class="login-meta-data text-center">
    <p class="mt-3 mb-0">Already have an account?<a class="ml-2" href="./login">Login</a></p>
</div>
</div>
</div>
