...
<div class="page-content-wrapper">
            ...
            <?php
            $stmt = $conn->query("SELECT b.title,b.featured_image,b.createdAt,b.blog_id,c.category_name,c.category_id FROM blogs b right join categories c on b.categories = c.category_id  where b.featured =1 and b.blog_state = '$user_state' order by b.id DESC limit 9");
            $stmt->execute();
